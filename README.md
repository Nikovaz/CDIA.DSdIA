...
[![IFTS 24](https://img.shields.io/badge/IFTS%20Nº24-Ciencia%20de%20Datos%20e%20IA-1f4287?style=for-the-badge)](https://ifts24.edu.ar)
[![Docente](https://img.shields.io/badge/Docente-Valeria%20Feito-008080?style=for-the-badge)]()
[![Estudiante](https://img.shields.io/badge/Estudiante-Nicolás%20Galarza%20Vázquez-blue?style=for-the-badge)](https://github.com/Nikovaz)
[![Python](https://img.shields.io/badge/Python-3.11+-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)

**Estudiante:** Galarza Vázquez, Nicolás  
...
* **Arquitectura de Agentes y Sistemas Inteligentes:** Comprensión profunda del modelado de algoritmos para la toma de decisiones automatizada y su impacto en procesos de negocio.
* **Ciclo Integral de Ciencia de Datos:** Rigurosidad metodológica desde la ingesta de datos, limpieza y Análisis Exploratorio de Datos (EDA) hasta el modelado supervisado/no supervisado.
* **Entornos Cloud y Versionado Profesional:** Uso coordinado de **DeepNote**, **Git** y **GitHub** para garantizar la reproducibilidad y trazabilidad del código.
* **Data Storytelling y Comunicación Ejecutiva:** Capacidad para traducir métricas estadísticas complejas a conclusiones claras para stakeholders.
...
### 📓 TP 03: Ecosistema de Librerías para Ciencia de Datos
* **Bajada Descriptiva:** En este trabajo práctico se abordó la importación y utilización de librerías esenciales en Python (NumPy, Pandas, Matplotlib, Seaborn y Scikit-Learn), la creación y manipulación de DataFrames y la fundamentación del criterio de selección de herramientas según cada caso de uso en proyectos de IA.
* 🔗 **Enlace:** [003-PythonLibrerias/TP03_PythonLibrerias.ipynb](./003-PythonLibrerias/TP03_PythonLibrerias.ipynb)
